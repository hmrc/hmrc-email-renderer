...
class SuccessfulXmlSubmissionPlatformOperatorSpec extends PlaySpec with CommonParamsForSpec {

  "dprs_successful_xml_submission_platform_operator" must {
    ...
    "include htmlTemplate body and footer" in {
      ...
      htmlContent must include("We may contact you if we have any questions about this report.")
