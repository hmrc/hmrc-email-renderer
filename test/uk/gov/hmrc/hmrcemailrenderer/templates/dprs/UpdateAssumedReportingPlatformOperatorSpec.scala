...
class UpdateAssumedReportingPlatformOperatorSpec extends PlaySpec with CommonParamsForSpec {
  ...
  "dprs_update_assumed_reporting_platform_operator" must {
    ...
    "include htmlTemplate body and footer" in {
      ...
      htmlContent must include("Assumed reporting details have been updated for you at 9:15am on 25 January 2024.")
