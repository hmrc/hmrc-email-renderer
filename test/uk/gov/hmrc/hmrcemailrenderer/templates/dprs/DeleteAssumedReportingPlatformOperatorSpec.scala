...
class DeleteAssumedReportingPlatformOperatorSpec extends PlaySpec with CommonParamsForSpec {

  "dprs_delete_assumed_reporting_platform_operator" must {
    ...
    "include correct subject" in {
      underTest.subject(
        commonParameters
      ) mustBe "Assumed reporting details deleted for you for digital platform reporting"
    }
    ...
    "include htmlTemplate body and footer" in {
      val htmlContent = underTest
        ...
        .toString
      htmlContent must include("Assumed reporting details deleted for you for digital platform reporting")
      htmlContent must include("Dear")
      htmlContent must include("Tim Vinted")
      htmlContent must include("Assumed reporting details have been deleted for you at 9:15am on 25 January 2024.")
