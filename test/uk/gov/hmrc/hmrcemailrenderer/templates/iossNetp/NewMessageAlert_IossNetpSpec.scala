...
import uk.gov.hmrc.hmrcemailrenderer.templates.ServiceIdentifier.{ Ioss, IossNetp }

class NewMessageAlert_IossNetpSpec extends PlaySpec with CommonParamsForSpec {

  "NewMessageAlert_IossNetp" must {
