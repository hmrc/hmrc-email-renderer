...
class ApiPasswordChangedConfirmationEmailSpec extends AnyWordSpec with Matchers {
  ...
  "textView" should {
    "render as" in new TestCase {
      ...
      renderedTxt.body should include("Your password for the HMRC Developer Hub has been reset.")
