...
class Pillar2TemplatesSpec extends PlaySpec with CommonParamsForSpec {
  ...
  "GIR Successful Submission Template" must {
    ...
    val successTemplate: MessageTemplate = MessageTemplate.create(
      ...
      service = Pillar2,
      subject = "GloBE Information Return: successful submission",
    ...
    "include correct subject" in {
      successTemplate.subject(
        params
      ) mustBe "GloBE Information Return: successful submission"
    }
    ...
    "include htmlTemplate body with correct content" in {
      ...
      htmlContent must include("Thank you.")
      htmlContent must include("HM Revenue and Customs")
      htmlContent must include("Customer Compliance Group")
    }
    ...
    "include txtTemplate body with correct content" in {
      ...
      txtContent must include("You do not need to take any further action.")
      txtContent must include("If you have any queries, please contact the Pillar 2 team at pillar2mailbox@hmrc.gov.uk")
      txtContent must include("Thank you.")
  ...
  "GIR Generic Errors Template" must {
    ...
    val genericErrorsTemplate: MessageTemplate = MessageTemplate.create(
      ...
      fromAddress = "pillar2@notifications.service.gov.uk",
      service = Pillar2,
      subject = "GloBE Information Return: Errors identified",
    ...
    "include correct subject" in {
      genericErrorsTemplate.subject(
        paramsBase
      ) mustBe "GloBE Information Return: Errors identified"
    }
    ...
    "include htmlTemplate body with error table" in {
      ...
      htmlContent must include("Accounting period: 1 April 2023 to 31 March 2024")
      htmlContent must include("Received: 2:30pm on 1 January 2024")
      htmlContent must include("We have processed your GIR submission and identified the errors in the table below.")
      htmlContent must include("What you need to do next")
      htmlContent must include("You must correct these errors and re-submit your return")
      htmlContent must include("before your submission deadline date")
      htmlContent must include("You may be charged penalties if you submit a return after your deadline date.")
      htmlContent must include(
    ...
    "include txtTemplate body with errors" in {
      ...
      txtContent must include("Accounting period: 1 April 2023 to 31 March 2024")
      txtContent must include("Received: 2:30pm on 1 January 2024")
      txtContent must include("We have processed your GIR submission and identified the errors in the table below.")
      txtContent must include("What you need to do next")
      txtContent must include(
        "You must correct these errors and re-submit your return before your submission deadline date."
      )
      txtContent must include("You may be charged penalties if you submit a return after your deadline date.")
      txtContent must include(
        "You should contact your software provider if you need further guidance on how to correct these errors."
      )
      txtContent must include("Thank you.")
