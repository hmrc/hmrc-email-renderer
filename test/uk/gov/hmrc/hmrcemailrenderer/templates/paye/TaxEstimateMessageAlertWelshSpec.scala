...
class TaxEstimateMessageAlertWelshSpec  extends UnitSpec with EitherValues with TemplateLoader with CommonParamsForSpec {
  ...
  "tax_estimate_message_alert_cy" should {
    ...
    val template = templateLocator.templateGroups("PAYE").find(_.templateId == "tax_estimate_message_alert_cym").get
    ...
    "render correct html content" in {
      ...
      htmlContent should include("Dylech wirio’ch manylion i wneud yn siŵr eu bod yn gywir. Mae hyn fel eich bod yn talu’r swm cywir o Dreth Incwm.")
      ...
      htmlContent should include("Am resymau diogelwch, nid ydym wedi cynnwys cysylltiad yn yr e-bost hwn. I gyrraedd eich Cyfrif Treth Personol, chwiliwch am ‘Cyfrif Treth Personol CThEM’.")
      htmlContent should include("Mewngofnodi")
      htmlContent should include("Defnyddiwch eich manylion Dynodydd Defnyddiwr neu Ddilysu i fewngofnodi i’ch Cyfrif Treth Personol.")
      htmlContent should include("Dylech gael mynediad at y rhain gan eich bod eisoes wedi defnyddio’r gwasanaeth i ddewis cael e-byst.")
      ...
      htmlContent should include("Cawsoch yr e-bost hwn am eich bod wedi dewis cael diweddariadau e-bost yn lle llythyrau drwy’r bost")
    ...
    "render correct text content" in {
      ...
      txtContent should include("Dylech wirio’ch manylion i wneud yn siŵr eu bod yn gywir. Mae hyn fel eich bod yn talu’r swm cywir o Dreth Incwm.")
      ...
      txtContent should include("Am resymau diogelwch, nid ydym wedi cynnwys cysylltiad yn yr e-bost hwn. I gyrraedd eich Cyfrif Treth Personol, chwiliwch am ‘Cyfrif Treth Personol CThEM’.")
      txtContent should include("Mewngofnodi")
      txtContent should include("Defnyddiwch eich manylion Dynodydd Defnyddiwr neu Ddilysu i fewngofnodi i’ch Cyfrif Treth Personol.")
      txtContent should include("Dylech gael mynediad at y rhain gan eich bod eisoes wedi defnyddio’r gwasanaeth i ddewis cael e-byst.")
      ...
      txtContent should include("Cawsoch yr e-bost hwn am eich bod wedi dewis cael diweddariadau e-bost yn lle llythyrau drwy’r bost")
