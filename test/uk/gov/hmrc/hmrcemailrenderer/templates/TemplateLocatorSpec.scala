  ...
  "The template locator" should {
    ...
    "enumerate all template identifiers" in {
      TemplateLocator.all.map(_.templateId) should contain.only(
        ...
        "crs_file_upload_unsuccessful",
        "fatca_file_upload_unsuccessful",
        "crs_fi_upload_successful",
        "fatca_fi_upload_successful",
        "crs_user_upload_successful",
        "fatca_user_upload_successful",
