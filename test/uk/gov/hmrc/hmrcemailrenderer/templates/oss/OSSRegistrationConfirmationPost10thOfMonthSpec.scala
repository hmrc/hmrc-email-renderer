...
class OSSRegistrationConfirmationPost10thOfMonthSpec
    extends WordSpecLike with Matchers with OptionValues with EitherValues with TemplateLoader with CommonParamsForSpec {
  ...
  "OSS Registration Confirmation" should {
    ...
    val template = templateLocator
      .templateGroups("OSS")
      .find(_.templateId == "oss_registration_confirmation_post_10th_of_month")
      .get

    "render correct meta information" in {
      template.templateId shouldBe "oss_registration_confirmation_post_10th_of_month"
    ...
    "render correct html content" in {
      ...
      htmlContent should include(
        "You registered after the 10th day of the next month following your first eligible sale.")
    ...
    "render correct text content" in {
      ...
      txtContent should include(
        "You registered after the 10th day of the next month following your first eligible sale.")
      txtContent should include("Between 1 July 2021 and 30 September 2021")
      txtContent should include(
        "If your eligible sales in any 12-month period goes over £8,818 (10,000 euros), you need to register for and pay VAT in each EU country where you made those sales.")
      txtContent should include("01 October 2021 onwards")
