...
class AtsAnnualTaxReturnWelshSpec extends UnitSpec with EitherValues with TemplateLoader with CommonParamsForSpec {
  ...
  "annual_tax_summaries_message_alert_cy" should {
    ...
    val template = templateLocator.templateGroups("ATS").find(_.templateId == "annual_tax_summaries_message_alert_cy_").get
    ...
    "render correct html content" in {
      ...
      htmlContent should include("Os oes gennych Gyfrif Treth Busnes, dewiswch Hunanasesiad ac yna ‘rhagor o fanylion Hunanasesiad’ ac yna dewiswch ‘gweld sut y caiff eich treth ei gwario’.")
      htmlContent should include("Mae crynodebau treth er gwybodaeth yn unig felly nid oes angen cymryd unrhyw gamau pellach.")
    ...
    "render correct text content" in {
      ...
      txtContent should include("Os oes gennych Gyfrif Treth Busnes, dewiswch Hunanasesiad ac yna ‘rhagor o fanylion Hunanasesiad’ ac yna dewiswch ‘gweld sut y caiff eich treth ei gwario’.")
      txtContent should include("Mae crynodebau treth er gwybodaeth yn unig felly nid oes angen cymryd unrhyw gamau pellach.")
