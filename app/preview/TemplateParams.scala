...
object TemplateParams2 {
  ...
  val exampleParams = Map(
    ...
    "recon_mods_finance_report" -> Map(
      ...
      "MODS_OPS_ROW_123-456-789"  -> "123-456-789,OPSMIBREF1234,100,100,200,100,300",
      "MODS_OPS_ROW_234-567-890"  -> "234-567-890,OPSMIBREF2345,100,100,200,100,300",
      "MODS_OPS_ROW_098-765-432"  -> "098-765-432,OPSMIBREF3456,100,100,200,100,300",
      "MODS_OPS_ROW_987-654-321"  -> "987-654-321,OPSMIBREF4567,100,100,200,100,300",
      "MODS_TOPS_ROW_123-456-789" -> "123-456-789,TOPSMIBREF1234,100,100,200,100,300",
      "MODS_TOPS_ROW_234-567-890" -> "234-567-890,TOPSMIBREF2345,100,100,200,100,300",
      "MODS_TOPS_ROW_098-765-432" -> "098-765-432,TOPSMIBREF3456,100,100,200,100,300",
      "MODS_TOPS_ROW_987-654-321" -> "987-654-321,TOPSMIBREF4567,100,100,200,100,300"
    ),
