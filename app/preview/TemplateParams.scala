...
object TemplateParams3 {
  val exampleParams = Map(
    ...
    "fullyDynamicEmail_confirmation" -> Map(
      "heading1"  -> "",
      "heading2"  -> "",
      "heading3"  -> "If you have not yet paid",
      "heading4"  -> "",
      "heading5"  -> "",
      "heading6"  -> "",
      "heading7"  -> "",
      ...
      "para2"     -> "We have received your notification about the amount of VAT owed on goods moved.",
      "para3"     -> "Your payment reference:",
      "para4"     -> "Payment amount:",
      "para5"     -> "• Go to GOV.UK",
      "para6"     -> "• Search for ‘Pay taxes, penalties or enquiry settlements’",
      "para7"     -> "• Follow the payment instructions on the page, using the payment details in this email.",
      "para8"     -> "If we need to contact you, we will use the details you provided.",
      "para9"     -> "For security reasons, we have not included the details you submitted.",
      ...
      "para12"    -> "From HMRC Customer Services Group",
      "para13"    -> "",
      "para14"    -> "",
      "para15"    -> "",
      "para16"    -> "",
      ...
      "bold19"    -> "",
      "bold20"    -> "",
      "emailSubjectConfirmation" -> "You have notified HMRC of VAT owed on goods moved"
    ),
