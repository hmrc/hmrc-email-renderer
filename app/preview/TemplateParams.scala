...
object TemplateParams2 {
  ...
  val exampleParams = Map(
    ...
    "cca_appeals_submission_data" -> Map(
      "assessmentRef"             -> "123412345",
      "address"                   -> "3, some place, AA1 1AA",
      "billingAuthorityCode"      -> "2323",
      "billingAuthorityReference" -> "GH23456JJJ",
      "listYear"                  -> "2017",
      "rateableValue"             -> "344553",
      "nameOfOccupier"            -> "Mr Bruce Almighty",
      "effectiveDate"             -> "01 April 2017",
      "propertyDescription"       -> "This is the property description",
      "ownerOccupier"             -> "Ricky Bobby",
      "ownersAddressIfDifferent"  -> "5, some other place, BB1 1AA",
      "rentPeriod"                -> "monthly",
      "effectiveDateChanged"      -> "03 January 2018",
      "dateFirstPayable"          -> "08 January 2019",
      "rateableValueAltered"      -> "532533",
      "existingEntryDividedInto"  -> "2",
      "otherChanges"              -> "other changes will be listed in this field",
      "currentRent"               -> "533",
      "existingEntryDeleted"      -> "false",
      "inaccurate"                -> "true",
      "propertyDemolished"        -> "true",
      "propertyDomestic"          -> "false",
      "deleteForOtherReasons"     -> "false",
      "moreThanOneAssessment"     -> "false",
      "statementOmitted"          -> "true",
      "rateableValueInaccurate"   -> "03 January 2019",
      "circumstancesChangedDate"  -> "03 April 2019",
      "effdtInaccurate"           -> "03 March 2019",
      "wrongByDecisionOf"         -> "valuationTribunal",
      "courtTribunalName"         -> "unknown",
      "inRespectToProperty"       -> "9, another place, CA1 1BB",
      "decisionDated"             -> "03 January 2018",
      "decisionRelevance"         -> "it is relevant",
      "believedRelevanceReasons"  -> "a relevant reason",
      "detailedReason"            -> "a really detailed reason",
      "capacity"                  -> "Owner",
      "correspondenceAddress"     -> "5, the best place, BB1 1AA",
      "daytimeTelephoneNumber"    -> "07452678987",
      "name"                      -> "Some guy",
      "commsViaEmail"             -> "true",
