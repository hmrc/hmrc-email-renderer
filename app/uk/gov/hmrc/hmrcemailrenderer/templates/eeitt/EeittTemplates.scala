...
object EeittTemplates {
  ...
  MessageTemplate.create(
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 1 Part 1 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 1 Part 2 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 1 Part 3 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 2 Authorised Economic Operator application",
    ...
    fromAddress = govUkTeamAddress,
    service = Eeitt,
    subject = "Submitted: your C118 Section 3 Part 1 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 3 Part 2 Authorised Economic Operator application",
      plainTemplate = txt.c118Section3Part2ApplicationConfirmation.f,
      htmlTemplate = html.c118Section3Part2ApplicationConfirmation.f,
      priority = Some(MessagePriority.Standard)
  ),
    MessageTemplate.create(
    templateId = "c118_section3_part3_application_confirmation",
    fromAddress = govUkTeamAddress,
    service = Eeitt,
    subject = "Submitted: your C118 Section 3 Part 2 Authorised Economic Operator application",
    plainTemplate = txt.c118Section3Part2ApplicationConfirmation.f,
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 4 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 5 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 6 Part 1 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 6 Part 2 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 6 Part 3 Authorised Economic Operator application",
    ...
    MessageTemplate.create(
      ...
      fromAddress = govUkTeamAddress,
      service = Eeitt,
      subject = "Submitted: your C118 Section 6 Part 4 Authorised Economic Operator application",
