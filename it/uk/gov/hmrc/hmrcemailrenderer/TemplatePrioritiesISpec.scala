...
class TemplatePrioritiesISpec extends UnitSpec
  ...
  object TestTemplates {
    ...
    val urgent = Table[String, Map[String, String]](
      ...
      ("transactionEngineHMRCPSAADDETSSuccess", Map("receivedDate" -> "01/01/01","identifier" -> "12345")),
      ("transactionEngineHMRCPSAADDETSFailure", Map("receivedDate" -> "01/01/01","identifier" -> "12345")),
      ...
      ("transactionEngineHMRCPSACOMBINEDSuccess", Map("receivedDate" -> "01/01/01","identifier" -> "12345")),
      ("transactionEngineHMRCPSACOMBINEDFailure", Map("receivedDate" -> "01/01/01","identifier" -> "12345")),
      ...
      ("transactionEngineHMRCPSAPRACAUTHSuccess", Map("receivedDate" -> "01/01/01","identifier" -> "12345")),
      ("transactionEngineHMRCPSAPRACAUTHFailure", Map("receivedDate" -> "01/01/01","identifier" -> "12345")),
      ("transactionEngineHMRCPSAPRACDEAUTHSuccess", Map("receivedDate" -> "01/01/01","identifier" -> "12345")),
      ("transactionEngineHMRCPSAPRACDEAUTHFailure", Map("receivedDate" -> "01/01/01","identifier" -> "12345")),
