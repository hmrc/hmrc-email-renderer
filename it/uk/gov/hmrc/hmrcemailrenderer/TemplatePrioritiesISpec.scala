...
class TemplatePrioritiesISpec extends UnitSpec
  ...
  object TestTemplates {
    ...
    val urgent = Table[String, Map[String, String]](
      ...
      ("transactionEngineECSLORGV101Success", Map.empty),
      ("transactionEngineECSLORGV101Failure", Map.empty),
      ("transactionEngineIRAACTSuccess", Map.empty),
      ("transactionEngineIRAACTFailure", Map.empty),
      ("transactionEngineIRAAPAYESuccess", Map.empty),
      ("transactionEngineIRAAPAYEFailure", Map.empty),
      ("transactionEngineIRAASASuccess", Map.empty),
      ("transactionEngineIRAASAFailure", Map.empty),
      ...
      ("transactionEngineIRCTFANNUALRETURNSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineIRCTFANNUALRETURNFailure", Map("receivedDate" -> "01/01/01")),
      ...
      ("transactionEngineHMRCPSAACCTTAXSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAACCTTAXFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAADDSCHASuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAADDSCHAFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAAMDDETSSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAAMDDETSFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAASSCSASuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAASSCSAFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSACOMBINEDREGSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSACOMBINEDREGFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAEVNTREPSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAEVNTREPFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAMAINTSCMSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAMAINTSCMFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSARASSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSARASFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAREGSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSAREGFailure", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSARETSuccess", Map("receivedDate" -> "01/01/01")),
      ("transactionEngineHMRCPSARETFailure", Map("receivedDate" -> "01/01/01")),
      ...
      //      ("transactionEngineHMRCPSAPRACDEAUTHFailure", Map("receivedDate" -> "01/01/01"))
    )
